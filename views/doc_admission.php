...
<div class="document-wrapper">
    <div class="document-a4">
        ...
        <div class="doc-title">Заява на вступ</div>
        
        <div class="doc-body">
            Прошу прийняти мене до складу членів Первинної профспілкової організації «<?= htmlspecialchars($ppo_name) ?>» з <?= date('d.m.Y', strtotime($app['created_at'])) ?> року. 
            <br><br>
            Зі Статутом профспілки ознайомлений(а) та зобов'язуюсь його виконувати.
            <br><br>
